...
import 'package:vhical_finder/View/DashBoard/Dashboard.dart';
import 'package:vhical_finder/model/user_chat.dart';
import 'package:vhical_finder/util/constant.dart';
import 'package:vhical_finder/util/sharePreference_instance.dart';
import 'package:vhical_finder/widget/loading.dart';
...
class LoginScreenState extends State<LoginScreen> {
  ...
  Future<Null> handleSignIn() async {
    ...
    this.setState(() {
     ...
     latlong = (await determinePosition()) as Position;
    print(latlong);
    // setState(() {
